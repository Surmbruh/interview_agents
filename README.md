...
**Multi-Agent Interview Coach** — это система автоматизации технических интервью на базе LangGraph с многоагентной архитектурой. Проект демонстрирует принципы Agentic Workflow: ролевую специализацию, скрытую рефлексию, адаптивность и устойчивость к вбросам.
...
| **Скрытая рефлексия** | Observer анализирует ответы и даёт инструкции Interviewer |
| **Сохранение контекста** | MemorySaver хранит историю, агенты помнят предыдущие ответы |
...
├── streamlit_app.py            # Веб-интерфейс (Glassmorphic UI)
...
Интерфейс доступен: `http://localhost:8501`
  ...
  "turns": [
    {
      ...
      "user_message": "Я Junior Backend Developer...",
...
2. **Технический анализ (Technical Review)**
   ...
   - ❌ Knowledge Gaps — ошибки с правильными ответами

3. **Soft Skills & Communication**
   - Clarity, Honesty, Engagement

4. **Персональный Roadmap**
   - Что изучить + ссылки на ресурсы (через DuckDuckGo Search)
...
| **Off-topic** | Observer → "Вернуться к теме интервью" |
...
*Проект создан для демонстрации возможностей Multi-Agent Systems и LangGraph.*
